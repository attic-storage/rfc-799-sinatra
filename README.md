# SINATRA 'End Of World' BOOTSTRAP [![build status](http://travis-ci.org/rlespinasse/sinatra-eow-bootstrap.png)](http://travis-ci.org/rlespinasse/sinatra-eow-bootstrap)
